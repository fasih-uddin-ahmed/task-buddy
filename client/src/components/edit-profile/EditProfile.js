...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    //now we are doing it to get profile because we are editing it.
    if (nextProps.profile.profile) {
      ...
      //if profile field does not exist, make empty string for field
      ...
      //now set component form fields state as these valuesss
      this.setState({
